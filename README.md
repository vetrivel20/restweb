...
<html>
    ...
    <body>
        ...
        <div class="img">
            <img src="restbg1.jpg" class="restbg1">
            <img src="restbg2.jpg" class="restbg2">
            <img src="restbg3.jpg" class="restbg3">
        </div>
        <nav class="nav2">
            <ul>
        ...
        <h2 style="text-align: center;" class="footer2">&copy; M.Vetrivel [25011461]</h2>
    </body>
</html>
...
<html>
    ...
    <body>
        ...
        <div class="mainbox">
            <div class="box1">
            <img src="food1.jpg" class="food1">
            <h3 style="text-align: center;">Burger</h3>
            <h4>RS : 149</h4>
        </div>
        <div class="box2">
            <img src="food2.jpg" class="food2">
            <h3 style="text-align: center;">Pizza</h3>
            <h4>RS : 299</h4>
        </div>
        <div class="box3">
            <img src="food3.webp" class="food3">
            <h3 style="text-align: center;">Noodles</h3>
            <h4>RS : 99</h4>
        </div>
        <div class="box4">
            <img src="food4.webp" class="food4">
            <h3 style="text-align: center;">KFC Chicken</h3>
            <h4>RS : 299</h4>
        </div>
        <div class="box5">
            <img src="food5.avif" class="food5">
        ...
        <h2 class="footer3">&copy; M.Vetrivel [25011461]</h2>
    </body>
</html>
...
<html>
    ...
    <body>
        ...
        <div class="adminbox">
            ...
            <div class="admin3">
                <img src="3.webp" class="three">
                <h3>Sanji</h3>
                <h3>Chief Cook</h3>
            </div>
            <div class="admin4">
                <img src="4.webp" class="four">
                <h3>Kira</h3>
                <h3>Operation Manager</h3>
            </div>
            <div class="admin5">
                <img src="5.jpg" class="five">
                <h3>Tony</h3>
                <h3>HR Manager</h3>
            </div>
            <div class="admin6">
                <img src="6.jpg" class="six">
                <h3>Punisher</h3>
                <h3>Security</h3>
            </div>
        </div><br><br>
        ...
        <h2 class="footer4">&copy; M.Vetrivel [25011461]</h2>
    </body>
</html>
